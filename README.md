...
##  INFO/STEPS TO RUN :
#### 1a.Create a virtual environment if necessary and install the requirements mentioned in requirements.txt
#### 1b.If installation from the txt file fails,Install the following modules manually :
##### <i>flask
